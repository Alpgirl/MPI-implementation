// UPDATE!
// Speed up is low. Ideas:
// 1. delete functiom call F().
// 2. Use lists instead of arrays. It's easier to delete or add new element in it
...
int main(int argc, char* argv[]){
    int rank, size, N = 1e+8, N_global, N_add, N_eq, cnt = 0;
    double sum = 0, dx, tmp;
